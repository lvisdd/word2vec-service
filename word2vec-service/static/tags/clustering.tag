...
<script>
  ...
  nv.addGraph(function () {
    ...
    d3.json(url, function (json) {
        ...
        // cluster_centers = json[0].cluster_centers;
        // cluster_nodes = json[0].cluster_nodes;
        
        // console.log(json);
        data = json[0].cluster_centers;
        // console.log(data);
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].group >= 0) {
              words[data[i].group].values.push({
                x: data[i].x
                , y: data[i].y
                , size: 10
                  // , size: Math.random()
              ...
              words[noisy_number].values.push({
                x: data[i].x
                , y: data[i].y
                , size: 10
                  // , size: Math.random()
